      ...
      <div class="navbar navbar-fixed-top navbar-inverse">
            <div class="navbar-inner">
                <div class="container">
					...
					<li class="active"><a rel="tooltip"  data-placement="bottom" title="About Us" id="aboutus" href="about.php" class=""></i>&nbsp;About Us</a></li>
		...
		<div class="margin-top">
			<div class="row">
			 ...
			 <img src="img/dr.png">
				...
				<p><a rel="tooltip"  data-placement="bottom" title="Click Here to Sign UP" id="signup" href="signup.php">Not a Member? Eh bobo ka!</a></p>
				</div>
				<!--- login -->
