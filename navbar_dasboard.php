		...
		<div class="container">
			...
			<div class="nav-collapse collapse">
				<ul class="nav">
					...
					<li class="active" >
						<a href="dasboard.php" class="">&nbsp;</i>&nbsp;<?php echo $row['firstname']." ".$row['lastname']; ?></a>
					</li>			
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#">
							<i class="icon-large"></i>&nbsp;Account
							<b class="caret"></b>
						</a>
						<ul class="dropdown-menu">
							...
							<li><a href="history.php"><i class="icon-rotate-left icon-large"></i>&nbsp;History</a></li>
