		...
		Time is:&nbsp;<input type="submit" class="trans" name="face" value="">
                        ...
                        ?>
								...
								<ul class="nav nav-tabs nav-stacked">
									<li><a href="sched_today.php"></i>&nbsp;Schedule for Today</a></li>
									<li><a href="schedule.php"></i>&nbsp;Schedule</i></a></li>
									<li><a href="service.php"></i>&nbsp;Service</a></li>
									<li><a href="user.php"></i>&nbsp;User Accounts</a></li>
									<li><a href="members.php"></i>&nbsp;Members</a></li>
									<li><a href="note.php"></i>&nbsp;Note</a></li>
								</ul>
							</div>