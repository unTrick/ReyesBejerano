...
<head>
	...
	<script type="text/javascript" charset="utf-8" language="javascript" src="../js/fabric.js"></script>
	<script type="text/javascript" charset="utf-8" language="javascript" src="../js/spectrum.js"></script>
